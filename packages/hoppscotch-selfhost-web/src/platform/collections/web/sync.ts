...
> = {
  ...
  async updateCollectionOrder({
    ...
    // console.log(
    //   `updating collection order in /Users/elizabethterveen/Desktop/CMU/17313/hoppscotch/packages/hoppscotch-selfhost-web/src/platform/collections/web/sync.ts\n`
    // )
